...
require github.com/soypat/cyw43439 v0.0.0-20250106095300-90bf0c1db251

// Necessary to work around API/device impedance mismatch.
replace tinygo.org/x/bluetooth => github.com/kortschak/bluetooth v0.0.0-20250118010558-f8fbed13f670
